/* =========================
   Base de datos
========================= */
CREATE DATABASE IF NOT EXISTS powertech
...
CREATE TABLE SALONES (
  codigoSalon     VARCHAR(10)  NOT NULL,
  codigoEdificio  VARCHAR(10)  NOT NULL,
  nombreSalon     VARCHAR(60)  NULL,
  PRIMARY KEY (codigoSalon),
  CONSTRAINT FK_SALONES_EDIFICIOS
...
CREATE TABLE DISPOSITIVOS (
  ...
  CONSTRAINT FK_DISPOSITIVOS_SALONES
    FOREIGN KEY (codigoSalon)
    REFERENCES SALONES (codigoSalon)
    ON DELETE CASCADE
    ON UPDATE RESTRICT
) ENGINE=InnoDB;
